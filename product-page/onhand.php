...
<body>
	...
	<div class="prod-body">
	   ...
	   <?php 
            $query = "SELECT * FROM onhand_products ORDER BY id ASC";
        ...
        ?>
                         ...
                         <form method="post" action="onhand.php?action=add&id=<?php $row["id"] ?>">
                            <div class="main-products">
										<img src="<?php echo $row["image"]; ?>" alt="product image">
										
                                 	    <div class="product-info">
											<h3><?php echo $row["onhand_name"];?></h3>
											<p>Price: Php <?php echo $row["onhand_price"];?></p>
											...
											<input type="hidden" name="hidden_name" value="<?php echo $row["onhand_name"]; ?> ">
											<input type="hidden" name="hidden_price" value="<?php echo $row["onhand_price"]; ?> ">
